...
<body>
    ...
    <div class="divform">
        <h1 style="color: white;padding-bottom: 20px; text-align: center; margin-top: 0; ">Login</h1>
        <form class="form" name="myForm" action="" onsubmit="return validateForm(this)" method="post">
